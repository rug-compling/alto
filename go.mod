module github.com/rug-compling/alto

go 1.21.1

replace github.com/ungerik/go-cairo => /home/peter/go/src/github.com/pebbe/go-cairo
...
require (
	...
	github.com/ungerik/go-cairo v0.0.0-20240303085021-95567bf85217
